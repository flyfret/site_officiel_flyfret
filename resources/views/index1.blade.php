...
@section('ChildContent')
    ...
    <section class="hero-slider" style=" min-height: 80vh; position: relative; overflow: hidden; background-color: #2d2f31;">
        <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <!-- Added carousel-fade for smooth transition -->
            <!-- Indicators -->
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active"
                    style="min-height: 80vh; background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('/assets/images/slider/slider-1.jpg') center/cover no-repeat;">
                    <div class="container h-100 d-flex align-items-center">
                        <div class="row">
                            <div class="col-12">
                                <h1 class="mb-4"
                                    style="font-size: 2.5rem; line-height: 1.3; color: #fff; font-weight: 700;">
                                ...
                                <p class="lead mb-5" style="font-size: 1.25rem; color: rgba(255,255,255,0.9);">
                                    Un service d'expédition rapide, sécurisé et parfaitement adapté à vos besoins personnels
                                    et professionnels
                                </p>
                                <div class="slider-btns-responsive">
                                    <a href="/envoi-colis" class="slider-btn slider-btn-primary">Envoyer un colis</a>
                                    <a href="{{ route('suiviColis') }}" class="slider-btn slider-btn-secondary">Suivre
                                        l'acheminement</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="carousel-item"
                    style="min-height: 80vh; background: linear-gradient(rgba(123, 1, 247, 0.3), rgba(123, 1, 247, 0.3)), url('/assets/images/slider/imageAccueil.jpg') center/cover no-repeat;">
                    <div class="container h-100 d-flex align-items-center">
                        <div class="row">
                            <div class="col-12">
                                <h1 class="mb-4"
                ...
                <!-- Slide 3 (Added) -->
                <div class="carousel-item"
                    style="min-height: 80vh; background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('/assets/images/slider/bateau.jpg') center/cover no-repeat;">
                    <div class="container h-100 d-flex align-items-center">
                        <div class="row">
                            <div class="col-12">
                                <h1 class="mb-4"
                                ...
                                <p class="lead mb-5" style="font-size: 1.25rem; color: rgba(255,255,255,0.9);">
                                    Des solutions adaptées à chaque besoin, avec un suivi précis et un accompagnement
                                    personnalisé
                                </p>
                                <div class="slider-btns-responsive">
                                    <a href="/envoi-colis" class="slider-btn slider-btn-primary">Envoyer un colis</a>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="offer-card h-100 w-100">
                        ...
                        <p style="font-size: 1.1rem; color: #555;">
                            Expédiez vos colis entre Abidjan et Paris avec un service optimisé, des délais maîtrisés et un
                            suivi en temps réel.
                        </p>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="offer-card h-100 w-100">
                        ...
                        <p style="font-size: 1.1rem; color: #555;">
                            Optez pour notre service premium avec assurance incluse pour garantir la sécurité de vos colis
                            les plus précieux.
                        </p>
                        <a href="#" class="cta-btn mt-auto">Voir les détails</a>
                    </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <img src="/assets/images/achivement/2.png" alt="Prochains départs" class="img-fluid rounded-3 shadow"
                        loading="lazy">
                </div>
                    ...
                    <div class="departures-box p-5 rounded shadow-sm bg-white w-100">
                        ...
                        <div class="departure-item mb-4">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    <h4 style="font-size: 1.25rem; color: #333;">Expéditions hebdomadaires Abidjan - France
                                    </h4>
                                    <p style="color: #666;">
                        ...
                        <div class="testimonial-item">
                            <div class="testimonial-card">
                                ...
                                <p class="testimonial-text">
                                    "FlyFret a dépassé mes attentes ! Mon colis est arrivé à Paris en avance, intact et
                                    parfaitement scellé. Un service de qualité que je recommande à tous."
                                </p>
                                <div class="testimonial-author">
                                    <img src="{{asset('assets/images/koua.jpg')}}" alt="Kouadio S.">
                                    <div class="author-info">
                                        <h5>Kouadio S.</h5>
                                        <small>Acheteur international</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        <div class="testimonial-item">
                            <div class="testimonial-card">
                                ...
                                <p class="testimonial-text">
                                    "Première expérience avec FlyFret et très satisfaite. Le colis est arrivé intact et le
                                    prix était très compétitif par rapport aux autres transporteurs."
                                </p>
                                <div class="testimonial-author">
                                    <img src="{{asset('assets/images/etudiante.jpg')}}" alt="Aïssata T.">
                                    <div class="author-info">
                                        <h5>Aïssata T.</h5>
                                        <small>Étudiante en France</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        <div class="testimonial-item">
                            <div class="testimonial-card">
                                ...
                                <p class="testimonial-text">
                                    "Vraiment Flyfret vous êtes les meilleurs, rapidité du transfert des colis, à l'écoute
                                    du client. Chaque fin semaine mes colis sont devant moi et intact."
                                </p>
                                <div class="testimonial-author">
                                    <img src="{{asset('assets/images/achatIn.jpg')}}" alt="Fabrice A.">
                                    <div class="author-info">
                                        <h5>Fabrice A.</h5>
                                        <small>Client achat en ligne</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        <div class="testimonial-item">
                            <div class="testimonial-card">
                                ...
                                <p class="testimonial-text">
                                    "Service exceptionnel ! J'ai envoyé plusieurs colis avec FlyFret et à chaque fois c'est
                                    un sans-faute. Suivi précis, livraison rapide et personnel très professionnel."
                                </p>
                                <div class="testimonial-author">
                                    <img src="{{asset('assets/images/entrepreneur.jpg')}}" alt="Jean-Luc D.">
                                    <div class="author-info">
                                        <h5>Jean-Luc D.</h5>
    ...
    <section class="stats-section py-5">
        <div class="container">
            <div class="row justify-content-center align-items-center g-4"
                style="backdrop-filter: blur(2px); background:  border-radius: 18px;">
                <div class="col-12 col-md-5 mb-4 mb-md-0">
                    <div class="expertise-card p-4 rounded shadow text-center h-100 d-flex flex-column justify-content-center"
                        style="background: #2d2f31cc;">
        ...
        <div class="container">
            <div class="section-title">
                ...
                <p class="section-subtitle" style="font-size: 1.125rem; color: #6c757d;padding-top: 1rem;">
                    ...
                    FlyFret travaille avec des leaders mondiaux de la logistique pour garantir un service d'expédition
                    fiable, rapide et sécurisé à chaque envoi.
                </p>
            </div>
