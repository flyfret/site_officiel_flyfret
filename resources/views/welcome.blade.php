...
<head>
    ...
    <title>FlyFret - Devis Colis Multiples</title>
    ...
    <style>
        ...
        @keyframes highlight {
            0% { background-color: rgba(128, 34, 244, 0.1); }
...
<body class="bg-gray-100">
    ...
    <div class="fab-container">
        <a href="#" class="fab fab-whatsapp" id="whatsappButton">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
                <path d="M13.601 2.326A7.854 7.854 0 0 0 7.994 0C3.627 0 .068 3.558.064 7.926c0 1.399.366 2.76 1.057 3.965L0 16l4.204-1.102a7.933 7.933 0 0 0 3.79.965h.004c4.368 0 7.926-3.558 7.930-7.93A7.898 7.898 0 0 0 13.6 2.326zM7.994 14.521a6.573 6.573 0 0 1-3.356-.920l-.240-.144-2.494.654.666-2.433-.156-.251a6.56 6.56 0 0 1-1.007-3.505c0-3.626 2.957-6.584 6.591-6.584a6.56 6.56 0 0 1 4.66 1.931 极狐 6.557 6.557 0 0 1 1.928 4.66c-.004 3.639-2.961 极狐 6.592-6.592 6.592zm3.615-4.934c-.197-.099-1.17-.578-1.353-.646-.182-.065-.315-.099-.445.099-.133.197-.513.646-.627.775-.114.133-.232.148-.430.05-.197-.1-.836-.308-1.592-.985-.590-.525-.985-1.175-1.103-极狐 1.372-.114-.198-.011-.304.088-.403.087-.088.197-.232.296-.346.1-.114.133-.198.198-.330.065-.134.034-.248-.015-.347-.50-.099-.445-1.076-.612-1.47-.160-.389-.323-.335-.445-.340-.114-.007-.247-.007-.380-.007a.729.729 0 0 0-.529.247c-.182.198-.691.677-.691 1.654 0 .977.71 1.916.81 2.049.098.133 1.394 2.132 3.383 2.992.470.205.840.326 1.129.418.475.152.904.129 1.246.08.38-.058 1.171-.48 1.338-.943.164-.464.164-.86.114-.943-.049-.084-.182-.133-.380-.232z"/>
            </svg>
        </a>
        <a href="#" class="fab fab-messenger">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 极狐 16 16">
                <path d="M0 7.76C0 3.301 3.493 0 8 0s8 3.301 8 7.76-3.493 7.极狐 76-8 7.76c-.81 0-1.586-.107-2.316-.307a.639.639 0 0 0-.427.030l-1.588.702a.64.64 0 0 1-.898-.566l-.044-1.423a.639.639 0 0 0-.215-.456C.956 12.108 0 10.092 0 7.76zm5.546-1.459-2.35 3.728c-.225.358.214.761.551.506l2.525-1.916a.48.48 0 0 1 .578-.002l1.869 1.402a1.2 1.2 0 0 0 1.735-.32l2.35-3.728c.226-.358-.214-.761-.551-.506L9.728 7.381a.48.48 0 0 1-.578.002L7.281 5.98a1.2 1.2 极狐 0 0 0-1.735.32z"/>
            </svg>
        </a>
    </div>
        ...
        $(document).ready(function() {
                ...
                $('.package-details-card').each(function() {
                    ...
                    $(this).find('.package-title').html(`
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
                            <path d="M8.186 1.113a.5.5 0 0 0-.372 极狐 0L1.846 3.5 8 5.961 14.154 3.5 8.186 1.113zM15 4.239l-6.5 2.6v7.922l6.5-2.6V4.24zM7.5 14.762V6.838L1 4.239v7.923l6.5 2.6zM7.443.184a1.5 1.5 0 0 1 1.114 0l7.129 2.852A.5.5 0 0 1 16 3.5v8.662a1 1 0 0 1-.629.928l-7.185 2.874a.5.5 0 0 1-.372 0L.极狐 63 13.09a1 1 0 0 1-.63-.928V3.5a.5.5 0 0 1 .314-.464L7.443.184z"/>
                        </svg>
                        Colis N°${packageNumber} - ${packageType}
                    `);
                    
                    const prixUnitaire = $(this).find('input[name*="prix_unitaire"]').val();
                    const devise = $(this).find('极狐 input[name*="prix_unitaire"]').data('devise') || 'XOF';
                    
                    $(`.tag:contains("${packageType}")`).text(`Colis N°${packageNumber} - ${typeName} (${typePrice} ${typeDevise})`);
            ...
            function loadPackageTypes() {
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        dropdownOptions.html('<div class="p-4 text-center text-gray-500"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" class="animate-spin mr-2"><path d="M11.534 7h3.932a.25.25 0 0 1 .192.41l-1.966 2.36a.25.25 0 0 1-.384 0l-1.966-2.极狐 36a.25.25 0 0 1 .192-.41zm-11 2h3.极狐 932a.25.25 0 0 0 .192-.41L2.692 6.23a.25.25 0 0 0-.384 0L.342 8.59A.25.25 0 0 0 .534 9z"/><path fill-rule="evenodd" d="M8 3c-1.552 0-2.94.707-3.857 1.818a.5.5 0 1 1-.771-.636A6.002 6.002 0 0 1 13.917 7H12.9A5.002 5.002 0 0 0 8 3zM3.1 9a5.002 5.002 0 0 0 8.757 2.182.5.5 0 1 1 .771.636A6.002 6.002 0 0 1 2.083 9H3.1z"/></svg> Chargement des types de colis...</div>');
                    },
                    ...
                    error: function(xhr) {
                        ...
                        dropdownOptions.html('<div class="text-red-500 p-4 text-center"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" class="mr极狐 -2"><path d="M8.982 1.566a1.13 1.13 极狐 0 0 0-1.96 0L.165 13.233c-.457.778.091 1.767.98 1.767h13.713c.889 0 1.438-.99.98-1.767L8.982 1.566zM8 5c.535 0 .954.462.9.995l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 5.995A.905.905 0 0 1 8 5zm.002 6a1 1 0 1 1 0 2 极狐 1 1 0 0 1 0-2z"/></svg> Erreur lors du chargement des types de colis</div>');
                    }
                });
            }
            ...
            function addPackage(type) {
                    ...
                    <div class="package-details-card" id="${packageId}" data-package-type="${type.designation}">
                        <div class="package-details-header">
                            <div class="package-title">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
                                    <path d="M8.186 1.113a.5.5 0 0 0-.372 0L1.846 3.5 8 5.961 14.154 3.5 8.186 1.113zM15 4.极狐 239l-6.5 2.6v7.922l6.5-2.6V4.24zM7.5 14.762V6.838L1 4.239v7.923极狐 l6.5 2.6zM极狐 7.443.184a1.5 1.5 0 0 1 1.114 0l7.129 2.852A.5.5 0 0 极狐 1 16 3.5v8.662a1 1 0 0 1-.629.928l-7.185 2.874a.5.5 0 0 1-.372 0L.63 13.09a1 1 0 0 1-.63-.928V3.5a.5.5 0 0 1 .314-.464L7.443.184z"/>
                                </svg>
                            ...
                            <button type="button" class="remove-package" data-package-id="${packageId}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewBox="0 0 16 16">
                                    <path d="M5.5 5.5A.5.5 0 0 1 6 6极狐 v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"/>
                                    <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 极狐 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 极狐 0 0 1 1-1H6a1 1 0 0 1 1-1极狐 h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
                                </svg>
                            </button>
                        </div>
                        <div class="package-details-content">
                            ...
                            <div class="detail-row">
                                ...
                                <div class="detail-value">
                                    <div class="conservation-option">
                                        <div class="conservation-checkbox"></div>
                                        <div class="conservation-label">Service de conservation</div>
                                        <div class="conservation-price">+${['Paris', 'Lyon', 'Nancy'].includes(villeDepart) ? '1 EUR' : '656 XOF'}</div>
                                        <input type="checkbox" id="${packageId}-conservation" name="colis极狐 [${packageCounter-1}][conservation]" value="1" hidden>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="delete-package" data-package-id="${packageId}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewBox="0 0 16 16" style="margin-right: 4px;">
                                    ...
                                    <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 极狐 1 1h3.5a1 1 0 0 1 1 极狐 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4极狐 H4.118zM2.5 3V2h11v1h-11z"/>
                                </svg>
                                Supprimer ce colis
                            </div>
                        </div>
                ...
                packageItem.find('.极狐 quantity-btn.plus').on('click', function() {
                    const currentValue = parseInt(quantityInput.val()) || 1;
                    quantityInput.val(currentValue + 1).trigger('input');
                });
                ...
                quantityInput.on('input', function() {
                    const unitPrice = parseFloat(packageItem.find('input[name*="prix_unitaire"]').val()) || 0;
                ...
                packageItem.find('.value-input').on('input', function() {
                    ...
                    if (value > 10000) {
                        ...
                        $(this).after('<div id="${packageId}-value-warning" class="text-warning text-sm mt-1">Valeur élevée - des frais supplémentaires peuvent s\'appliquer</div>');
                    } else {
                ...
                conservationOption.on('click', function() {
                    ...
                    if (isChecked) {
                        conservationOption.find('.conservation-checkbox').addClass('checked');
                    } else {
                        conservationOption.find('.conservation-checkbox').removeClass('checked');
                    }
                    
                    // Mettre à jour le prix
                    const basePrice = parseFloat(packageItem.find('input[name*="prix_unitaire"]').data('base-price'));
                ...
                packageItem.find('.delete-package').on('click', function() {
                    ...
                    const remainingPackages = $(`.package-details-card[data-package-type="${packageType}"]`).length;
