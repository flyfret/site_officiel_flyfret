...
<head>
    ...
    <style>
        ...
        .conservation-checkbox input[type="checkbox"] {
            appearance: none;
            width: 18px;
            height: 18px;
        ...
        .conservation-checkbox input[type="checkbox"]:checked {
            background-color: var(--primary);
            border-color: var(--primary);
        }

        .conservation-checkbox input[type="checkbox"]:checked::after {
            content: "\f00c";
            ...
            <div class="devis-header-content">
                <a href="#" onclick="history.back()" class="back-btn">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 1 0 .708l4 4a.5.5 0 1 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z"/>
                    </svg>
                    Retour
                </a>
    ...
    <script>
        $(document).ready(function() {
            ...
            function addPackage(type) {
                ...
                const packageItem = $(`
                    <div class="package-item" id="${packageId}" data-package-type="${type.designation}">
                        ...
                        <div class="package-fields">
                            <div class="form-group">
                                <label for="${packageId}-quantity">
                                    Quantité
                                    <span class="tooltip-icon">?
                                        <span class="tooltip">Nombre d'unités de ce type de colis</span>
                                    </span>
                                </label>
                            ...
                            <div class="form-group">
                                <label for="${packageId}-value">
                                    Valeur Marchande
                                    <span class="tooltip-icon">?
                                        <span class="tooltip">Valeur estimée du contenu du colis</span>
                                    </span>
                                </label>
                                ...
                                <div class="conservation-checkbox" id="${packageId}-conservation-container">
                                    <input type="checkbox" id="${packageId}-conservation" name="colis[${packageCounter-1}][conservation]" value="1">
                                    <label for="${packageId}-conservation">Service de conservation</label>
                            ...
                            <div class="form-group">
                                <div class="total-price-container">
                                    <div class="total-price-row">
                                        ...
                                        <span id="${packageId}-total-price" class="total-price-value">${prixUnitaire} ${devise}</span>
                                    </div>
                                    <div class="total-price-row">
                                        <span class="price-per-unit">${prixUnitaire} ${devise}/unitaire</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                $(`#${packageId}-value`).on('input', function() {
                ...
                const conservationContainer = $(`#${packageId}-conservation-container`);
                const conservationCheckbox = $(`#${packageId}-conservation`);
                
                conservationContainer.on('click', function(e) {
                    if (e.target.tagName !== 'INPUT') {
                        conservationCheckbox.prop('checked', !conservationCheckbox.prop('checked')).trigger('change');
                    }
                });
                
                conservationCheckbox.change(function() {
                    ...
                    if (isChecked) {
                        conservationContainer.addClass('checked');
                        ...
                        conservationContainer.removeClass('checked');
                        newPrice = basePrice;
                    }
                    ...
                    $(`.price-per-unit`).text(newPrice.toFixed(2) + ' ' + devise + '/unitaire');
            ...
            function updatePackageTotalPrice(packageId, unitPrice, devise) {
                ...
                $(`.price-per-unit`).text(unitPrice.toFixed(2) + ' ' + devise + '/unitaire');
            }
